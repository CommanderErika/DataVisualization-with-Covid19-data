...
# -*- coding: utf-8 -*-
"""
Created on Sat Jun 27 00:09:58 2020
...
sns.barplot(x='Masculino', y='Age', data=data, order=faixa_et, facecolor=(1, 1, 1, 0),
                        errcolor=".2", edgecolor="0.2", label = 'Masculino '+nome, linewidth = 1.2)

bar = sns.barplot(x='Feminino', y='Age', data=data, order=faixa_et, facecolor=(1, 1, 1, 0),
                        errcolor="0.2", edgecolor="0.2",  label = 'Feminino '+nome, linewidth = 1.2)
...
plt.xticks(ticks = [-30, -25,-20,-15, -10, -5, 0, 5, 10, 15, 20, 25, 30], labels = labels)
